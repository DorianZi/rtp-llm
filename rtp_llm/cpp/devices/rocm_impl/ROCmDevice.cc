...
ROCmDevice::ROCmDevice(const DeviceInitParams& params): DeviceBase(params) {
    ...
    if (init_params_.device_resource_config.not_use_default_stream) {
        torch_default_stream_ = std::make_unique<at::hip::HIPStreamMasqueradingAsCUDA>(at::hip::getStreamFromPoolMasqueradingAsCUDA(true));
    } else {
        torch_default_stream_ = std::make_unique<at::hip::HIPStreamMasqueradingAsCUDA>(at::hip::getDefaultHIPStreamMasqueradingAsCUDA());
    }
    torch_comm_stream_ = std::make_unique<at::hip::HIPStreamMasqueradingAsCUDA>(at::hip::getStreamFromPoolMasqueradingAsCUDA(true));
    at::hip::setCurrentHIPStreamMasqueradingAsCUDA(*torch_default_stream_);
